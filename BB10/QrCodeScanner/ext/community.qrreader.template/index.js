...
var qrreader = require("./qrReaderJNEXT").qrreader,
...
module.exports = {
	...
	testFront: function (success, fail) {
		success(qrreader.getInstance().testFront());
	},
	testRear: function (success, fail) {
		success(qrreader.getInstance().testRear());
	}
};